...
//var NewApiRootUrl = 'http://47.95.215.238:80/api/';
var NewApiRootUrl = 'http://127.0.0.1:8088/api/';
module.exports = {
    ...
    ShopList: NewApiRootUrl + 'shop/list',  //
    ShopDetail: NewApiRootUrl + 'shop/detail',  
    ShopDelete: NewApiRootUrl + 'shop/delete',
    ...
    ShopSave: NewApiRootUrl + 'shop/save',  //保存商品信息
